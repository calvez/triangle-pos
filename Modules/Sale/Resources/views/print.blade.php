                ...
                <div class="card-body">
                    <div class="row mb-4">
                        ...
                        <div class="col-xs-4 mb-3 mb-md-0">
                            ...
                            <div>
                                Fizetés állapota: <strong>{{ $sale->payment_status }}</strong>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xs-4 col-xs-offset-8">
                            <table class="table">
                                <tbody>
                                <tr>
                                    <td class="left"><strong>Kedvezmény ({{ $sale->discount_percentage }}%)</strong></td>
                                    <td class="right">{{ format_currency($sale->discount_amount) }}</td>
                                </tr>
                                <tr>
                                    <td class="left"><strong>Adó típusa({{ $sale->tax_percentage }}%)</strong></td>
