                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-4 mb-3 mb-md-0">
                                <h5 class="mb-2 border-bottom pb-2">Beszállító Info:</h5>
                            ...
                            <div class="col-sm-4 mb-3 mb-md-0">
                                ...
                                <div>
                                    Fizetés állapota: <strong>{{ $purchase->payment_status }}</strong>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-sm-5 ml-md-auto">
                                <table class="table">
                                    <tbody>
                                    <tr>
                                        <td class="left"><strong>Kedvezmény ({{ $purchase->discount_percentage }}%)</strong></td>
                                        <td class="right">{{ format_currency($purchase->discount_amount) }}</td>
                                    </tr>
                                    <tr>
                                        <td class="left"><strong>Adó típusa({{ $purchase->tax_percentage }}%)</strong></td>
