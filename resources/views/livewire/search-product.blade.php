        ...
        <div class="card-body">
            <div class="form-group mb-0">
                <div class="input-group">
                    ...
                    <input wire:keydown.escape="resetQuery" wire:model.debounce.500ms="query" type="text" class="form-control" placeholder="{{__('triangle.Type product name or code....')}}">
                </div>
            </div>
        </div>
    </div>
